...
QLIB_ASHARE_PROMPT_OBLIGATION_RULE = "rdagent_factor_extraction_viability_relevance_duplicate_and_implementation_prompts_must_apply_source_boundary_forbidden_defaults_and_turnover_distinction"
...
QLIB_ASHARE_BANDIT_MAX_DRAWDOWN_METRIC_PATH = QLIB_ASHARE_PORTFOLIO_BANDIT_METRIC_PATHS[2]
QLIB_ASHARE_BANDIT_MAX_DRAWDOWN_SIGN_RULE = "qlib_sum_mode_max_drawdown_must_be_non_positive"
QLIB_ASHARE_BANDIT_MAX_DRAWDOWN_ZERO_RULE = "zero_max_drawdown_sets_drawdown_adjusted_return_to_zero"
...
def format_rd_agent_ashare_semantic_context(
    ...
    return "\n".join(
        [
            ...
            f"{prediction_signal.get('rdagent_model_loader_boundary_rule')}",
            "- prediction-signal serialized model loader boundary: "
            f"{prediction_signal.get('rdagent_model_json_loader_boundary_rule')}",
            "- prediction-signal benchmark fixture boundary: "
            f"{prediction_signal.get('rdagent_model_benchmark_fixture_boundary_rule')}",
            ...
            + ", ".join(str(item) for item in prediction_signal.get("rdagent_forbidden_model_types", [])),
            ...
            "- feedback-metric comparison result rule: " f"{feedback_metric.get('feedback_comparison_result_rule')}",
            "- feedback-metric comparison missing failure: "
            f"{feedback_metric.get('feedback_comparison_missing_failure')}",
            "- feedback-metric comparison invalid failure: "
